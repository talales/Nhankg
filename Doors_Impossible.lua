require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("Mode make by nhankg and thanhphok (Og Hunger(new)", true)
...
pcall(function()
    ...
    loadstring(game:HttpGet("https://raw.githubusercontent.com/eoyoustme/ohh/refs/heads/main/Guiding"))()
    
end)

local entityList = {
    {url = "https://raw.githubusercontent.com/eoyoustme/ohh/refs/heads/main/Disturbance1", delay = 150},
    ...
    {url = "https://raw.githubusercontent.com/eoyoustme/ohh/refs/heads/main/Torment12", delay = 360},
    ...
    {url = "https://raw.githubusercontent.com/eoyoustme/ohh/refs/heads/main/Draft1",delay = 315},
}
